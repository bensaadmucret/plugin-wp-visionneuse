 ...
 * Small = get_post_meta( get_the_ID(), 'dc_small', true )
 */
class DC_LINK_IMAGE {
	private $config = '{"title":"Advence Visionneuse Image","prefix":"dc_","domain":"DC","class_name":"DC_LINK_IMAGE","context":"advanced","priority":"high","cpt":"tx_pop_up","fields":[{"type":"media","label":"Small","return":"url","id":"dc_small"}]}';
	...
	private function media_button( $field ) {
		printf(
			...
			isset( $field['modal-button'] ) ? $field['modal-button'] : __( 'Select this file', 'DC' ),
			isset( $field['modal-title'] ) ? $field['modal-title'] : __( 'Choose a file', 'DC' ),
			$field['return'],
			$field['id'], $field['id'],
			isset( $field['button-text'] ) ? $field['button-text'] : __( 'Upload', 'DC' )
		);
	}
